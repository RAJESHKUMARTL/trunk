...
//		getActivity().requestWindowFeature(Window.FEATURE_NO_TITLE);
		    View rootview = inflater.inflate(R.layout.leave_request, container, false);
		    Spinner category = (Spinner)rootview.findViewById(R.id.leave_category);
			
		    
			final ImageView icon_ = (ImageView) rootview.findViewById(R.id.icon_change);
			RelativeLayout Leave_Cat_Click = (RelativeLayout)rootview. findViewById(R.id.leave_category_click);
			final LinearLayout Leave_Cat_Hide = (LinearLayout)rootview. findViewById(R.id.leave_category_hide);
			
			final ImageView icon_recent = (ImageView)rootview. findViewById(R.id.imageview2);
			RelativeLayout leave_recent_click = (RelativeLayout) rootview.findViewById(R.id.leave_recent_click);
			final LinearLayout leave_recent_hide = (LinearLayout) rootview.findViewById(R.id.leave_recent_hide);

			table_layout_recent = (TableLayout) rootview.findViewById(R.id.tableLayout2);
					...
					for (int j = 1; j <= col; j++) {
						...
						tv4.setGravity(Gravity.CENTER);
						{
							if (approval_Status.get(i).equals("Rejected")) {
								...
								tv4.setBackgroundResource(R.drawable.approve);
							} else {
