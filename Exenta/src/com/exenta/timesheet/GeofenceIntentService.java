...
public class GeofenceIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if(!geofencingEvent.hasError()) {
            ...
            case Geofence.GEOFENCE_TRANSITION_ENTER:
                notificationTitle = "Geofence Entered. Please make sure you are CLOCKIN";
                sendResult("Geofence Entered");
                Log.v(TAG, "Geofence Entered");
                break;
            case Geofence.GEOFENCE_TRANSITION_DWELL:
                notificationTitle = "Geofence Dwell";
                sendResult("Geofence Dwell");
                Log.v(TAG, "Dwelling in Geofence");
                break;
            case Geofence.GEOFENCE_TRANSITION_EXIT:
                notificationTitle = "Geofence Exit. Please make sure you are CLOCKOUT";
                sendResult("Geofence Exited");
                Log.v(TAG, "Geofence Exited");
                break;
            default:
                notificationTitle = "Geofence Unknown";
                sendResult("Geofence Unknown");
            }
    ...
    static final public String COPA_RESULT = "com.exenta.timeSheet.TimeSheetEntry";

    public void sendResult(String message) {
        Intent intent = new Intent(COPA_RESULT);
        if(message != null)
            intent.putExtra("COPA_MESSAGE", message);
        System.out.println("in broadcastttttttttttttttttttttt");
